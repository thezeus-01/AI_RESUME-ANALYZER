...
def render_analytics_section(resume_uploaded=False, metrics=None):
    ...
    st.markdown("""
        <div style='background: rgba(0, 20, 30, 0.3); border-radius: 15px; padding: 2rem; text-align: center; margin-bottom: 1rem;'>
            <div style='color: #FF9800; font-size: 2.5rem; margin-bottom: 1rem;'>
                <i class='fas fa-eye'></i>
            </div>
            <h2 style='color: white; font-size: 1.5rem; margin-bottom: 1rem;'>Resume Views</h2>
            <p style='color: #4CAF50; font-size: 2.5rem; font-weight: bold; margin: 0;'>{}</p>
        </div>
    ...
    st.markdown("""
        <div style='background: rgba(0, 20, 30, 0.3); border-radius: 15px; padding: 2rem; height: 100%;'>
            <h2 style='color: white; font-size: 1.5rem; margin-bottom: 1.5rem;'>
                <i class='fas fa-history' style='color: #FF9800; margin-right: 0.5rem;'></i> Recent Activity
            </h2>
    """, unsafe_allow_html=True)
    ...
    if resume_uploaded:
        ...
        st.markdown("""
            <div style='text-align: center; padding: 2rem; color: #666;'>
                <i class='fas fa-upload' style='font-size: 2.5rem; color: #FF9800; margin-bottom: 1rem;'></i>
...
def render_suggestions_section(resume_uploaded=False):
    ...
    st.markdown("""
        <div style='background: rgba(0, 20, 30, 0.3); border-radius: 15px; padding: 2rem; height: 100%;'>
            <h2 style='color: white; font-size: 1.5rem; margin-bottom: 1.5rem;'>
                <i class='fas fa-lightbulb' style='color: #FF9800; margin-right: 0.5rem;'></i> Suggestions
            </h2>
    """, unsafe_allow_html=True)
    ...
    if resume_uploaded:
        ...
        st.markdown("""
            <div style='text-align: center; padding: 2rem; color: #666;'>
                <i class='fas fa-file-alt' style='font-size: 2.5rem; color: #FF9800; margin-bottom: 1rem;'></i>
